...
// const { getInfoByEmail, updateInfoByID, updatePwdByID, updateAvatar } = require('../controllers/touristController')
// const { upload } = require('../middlewares/upload');
// const { verifyToken } = require("../middlewares/baseToken");

// //GET: get tourist info by email
// touristRoute.get("/getInfo/:email", getInfoByEmail);
