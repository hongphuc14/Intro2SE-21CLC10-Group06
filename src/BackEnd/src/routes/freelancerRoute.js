...
const { getInfoByID, updateInfoByID, updatePwdByID, uploadAvatar, uploadLicense } = require('../controllers/freelancerController')
const { upload } = require('../middlewares/upload');
const { verifyToken } = require("../middlewares/baseToken");

//GET: get freelancer info by id_guide
freelancerRoute.get("/getInfo/:id_guide", verifyToken, getInfoByID);
...
freelancerRoute.get("/getLicense/:id_guide", verifyToken, getLicense);
